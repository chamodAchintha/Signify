...
from signjoey.sinhala_sentence.test import test_translation_model  
...
def main():
    ...
    ap.add_argument("mode", choices=["train", "test", "train_classifier", 'test_classifier', 'train_translator', 'test_translator'], help="train a model or test")
    ...
    elif args.mode == 'test_translator':   
        test_translation_model(cfg_file=args.config_path)
    else:
